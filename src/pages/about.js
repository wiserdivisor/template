    ...
    <Layout pageTitle="About Us">
      <p style={{ color: "dimgrey", textAlign: "justify" }}>
        ...
        >
          ...
          objective of promoting E-Vehicles as a primary means of daily commute
          and other terrestial transport requirements. E-Vehicles will play a
          very important role in EV aggregator fleet companies, food & other
          commodity deliveries. Inter-city transport, etc. In the very near
          future, EVs will replace today's petrol and diesel vehicles and
        ...
        >
          ...
          Institute of Engineering & Applied Sciences-Mumbai (IEAS) is a member
          of the KBP Public Educational Consortium registered under the Bombay
          Public Trust Act 1949 (Govt of Maharashtra). Since the last 20 years,
          the organization has been actively engaged in education, community
          welfare and vocational training in Maharashtra. With a vision of
          reaching out to the youth in rural and sub-rural areas, and providing
          them training, employment, and self-employment opportunities.
        </div>
        <br />
        <br />
        <div id="ieas"
        ...
        >
          ...
          sector since last 21 years, the institute has developed and conducted
          several training programmes in Telecom, Electro-Mechanical Services,
          HVAC-MEP & Building Management Services (BMS), Piping design, Two &
          Four Wheeler Maintenance and repairs, CCTV, biometrics and E-Security.
          For several Government, Semi-Government, Corporate and Industrial
          entities.
        </div>
        <br />
        <br />
        ...
        >
          ...
          Nephrocare Health Services - brand owners of "Nephroplus - Network of
          dialysis centres and Enpidia dialysis training programme.
        </div>
        <br />
        <br />
